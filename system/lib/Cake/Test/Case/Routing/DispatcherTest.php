...
/**
 * EventsTestAppController class
 *
 * @package       Cake.Test.Case.Routing
 */
class EventsTestAppController extends AppController {
}

/**
 * EventsTestController class
 *
 * @package       Cake.Test.Case.Routing
 */
class EventsTestController extends EventsTestAppController {
 ...
 */
	public function testAutomaticPluginControllerDispatch() {
		...
		Configure::write('Routing.prefixes', array('admin'));
		CakePlugin::load('EventsTest', array('path' => '/fake/path'));
		Router::reload();
		require CAKE . 'Config' . DS . 'routes.php';
		...
		$this->assertSame($Dispatcher->controller->plugin, 'EventsTest');
		$this->assertSame($Dispatcher->controller->name, 'EventsTest');
