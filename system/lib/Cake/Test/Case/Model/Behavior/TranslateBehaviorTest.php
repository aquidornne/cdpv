 ...
 */
	public function testTranslateModel() {
		$this->loadFixtures('TranslateTable', 'Tag', 'TranslatedItem', 'Translate', 'User', 'TranslatedEvent', 'TranslateEvent');
		$TestModel = new Tag();
		...
		$TestModel = new TranslatedEvent();
		$translateModel = $TestModel->Behaviors->Translate->translateModel($TestModel);
		$this->assertEquals('TranslateEventModel', $translateModel->name);
 ...
 */
	public function testSaveAllTranslatedAssociations() {
		$this->loadFixtures('Translate', 'TranslateEvent', 'TranslatedItem', 'TranslatedEvent', 'User');
		$Model = new TranslatedEvent();
		$Model->locale = 'eng';

		$data = array(
			'TranslatedEvent' => array(
				'id' => 4,
				'user_id' => 1,
				'published' => 'Y',
				'title' => 'Title (eng) #1',
 ...
 */
	public function testTranslateWithAssociations() {
		$this->loadFixtures('TranslateEvent', 'TranslatedEvent', 'TranslatedItem', 'User', 'Comment', 'EventsTag', 'Tag');
