 ...
 */
	public function beforeFind($queryData) {
		if (!empty($queryData['lazyLoad'])) {
			if (!isset($this->Event, $this->Comment, $this->EventFeatured)) {
 ...
 * @package       Cake.Test.Case.Model
 */
class NumericEvent extends CakeTestModel {
 ...
 * @package       Cake.Test.Case.Model
 */
class Event10 extends CakeTestModel {
 ...
 * @package       Cake.Test.Case.Model
 */
class EventFeatured extends CakeTestModel {
 ...
 * @var array
 */
	public $belongsTo = array('EventFeatured', 'Category');
}
 ...
 * @package       Cake.Test.Case.Model
 */
class EventsTag extends CakeTestModel {
...
/**
 * EventFeaturedsTag class
 *
 * @package       Cake.Test.Case.Model
 */
class EventFeaturedsTag extends CakeTestModel {
 ...
 * @package       Cake.Test.Case.Model
 */
class AnotherEvent extends CakeTestModel {
 ...
 * @var array
 */
	public $belongsTo = array('AnotherEvent', 'Advertisement');
}
 ...
 * @package       Cake.Test.Case.Model
 */
class TestPluginEvent extends CakeTestModel {
 ...
 */
	public $belongsTo = array(
		'TestPluginEvent' => array(
			'className' => 'TestPlugin.TestPluginEvent',
			'foreignKey' => 'article_id',
		),
		'TestPlugin.User'
	);
...
/**
 * TranslateEventModel class.
 *
 * @package       Cake.Test.Case.Model
 */
class TranslateEventModel extends CakeTestModel {
 ...
 * @var string
 */
	public $name = 'TranslateEventModel';
...
/**
 * TranslatedEvent class.
 *
 * @package       Cake.Test.Case.Model
 */
class TranslatedEvent extends CakeTestModel {
 ...
 * @var string
 */
	public $translateModel = 'TranslateEventModel';
...
class EventB extends CakeTestModel {
 ...
 */
	public $hasMany = array(
		...
		'Event2' => array(
			'className' => 'Event2',
			'order' => 'Event2.published_date DESC',
 ...
 * @package       Cake.Test.Case.Model
 */
class Event2 extends CakeTestModel {
 ...
 * @var array
 */
	public $belongsTo = array('EventFeatured2', 'User2');
...
/**
 * EventFeatured2 class
 *
 * @package       Cake.Test.Case.Model
 */
class EventFeatured2 extends CakeTestModel {
 ...
 * @package       Cake.Test.Case.Model
 */
class CustomEvent extends AppModel {
