 ...
 */
	public function testGet() {
		...
		$result = Hash::get(array(), '1.Event.title');
		$this->assertNull($result);

		$result = Hash::get($data, '');
		$this->assertNull($result);

		$result = Hash::get($data, '0.Event.title');
		$this->assertEquals('First Event', $result);

		$result = Hash::get($data, '1.Event.title');
		$this->assertEquals('Second Event', $result);

		$result = Hash::get($data, '5.Event.title');
		$this->assertNull($result);

		$result = Hash::get($data, '1.Event.title.not_there');
		$this->assertNull($result);

		$result = Hash::get($data, '1.Event');
		$this->assertEquals($data[1]['Event'], $result);

		$result = Hash::get($data, array('1', 'Event'));
		$this->assertEquals($data[1]['Event'], $result);
	}
 ...
 */
	public function testExtractBasic() {
		...
		$result = Hash::extract($data, '0.Event.title');
		$this->assertEquals(array('First Event'), $result);

		$result = Hash::extract($data, '1.Event.title');
		$this->assertEquals(array('Second Event'), $result);
 ...
 */
	public function testExtractNumericKey() {
		$data = self::articleData();
		$result = Hash::extract($data, '{n}.Event.title');
		$expected = array(
 ...
 */
	public function testExtractAttributePresence() {
		...
		$result = Hash::extract($data, '{n}.Event[published]');
		$expected = array($data[1]['Event']);
		$this->assertEquals($expected, $result);

		$result = Hash::extract($data, '{n}.Event[id][published]');
		$expected = array($data[1]['Event']);
		$this->assertEquals($expected, $result);
	}
 ...
 */
	public function testExtractAttributeEquality() {
		...
		$result = Hash::extract($data, '{n}.Event[id=3]');
		$expected = array($data[2]['Event']);
		$this->assertEquals($expected, $result);
 ...
 */
	public function testExtractAttributePattern() {
		...
		$result = Hash::extract($data, '{n}.Event[title=/^First/]');
		$expected = array($data[0]['Event']);
		$this->assertEquals($expected, $result);

		$result = Hash::extract($data, '{n}.Event[title=/^Fir[a-z]+/]');
		$expected = array($data[0]['Event']);
		$this->assertEquals($expected, $result);
	}
 ...
 */
	public function testInsertMulti() {
		...
		$result = Hash::insert($data, '{n}.Event.insert', 'value');
		$this->assertEquals('value', $result[0]['Event']['insert']);
		$this->assertEquals('value', $result[1]['Event']['insert']);
 ...
 */
	public function testRemoveMulti() {
		...
		$result = Hash::remove($data, '{n}.Event.title');
		$this->assertFalse(isset($result[0]['Event']['title']));
		$this->assertFalse(isset($result[1]['Event']['title']));

		$result = Hash::remove($data, '{n}.Event.{s}');
		$this->assertFalse(isset($result[0]['Event']['id']));
		$this->assertFalse(isset($result[0]['Event']['user_id']));
		$this->assertFalse(isset($result[0]['Event']['title']));
		$this->assertFalse(isset($result[0]['Event']['body']));
	}
 ...
 */
	public function testMap() {
		...
		$result = Hash::map($data, '{n}.Event.id', array($this, 'mapCallback'));
	...
	public function testApply() {
		...
		$result = Hash::apply($data, '{n}.Event.id', 'array_sum');
 ...
 */
	public function testReduce() {
		...
		$result = Hash::reduce($data, '{n}.Event.id', array($this, 'reduceCallback'));
		$this->assertEquals(15, $result);
	}
