 ...
 * @package       Cake.Test.Case.Utility
 */
class RegisterEvent extends ClassRegisterModel {
}

/**
 * RegisterEventFeatured class
 *
 * @package       Cake.Test.Case.Utility
 */
class RegisterEventFeatured extends ClassRegisterModel {
}

/**
 * RegisterEventTag class
 *
 * @package       Cake.Test.Case.Utility
 */
class RegisterEventTag extends ClassRegisterModel {
}
 ...
 */
	public function testAddModel() {
		$Tag = ClassRegistry::init('RegisterEventTag');
		$this->assertInstanceOf('RegisterEventTag', $Tag);

		$TagCopy = ClassRegistry::isKeySet('RegisterEventTag');
		$this->assertTrue($TagCopy);

		$Tag->name = 'SomeNewName';

		$TagCopy = ClassRegistry::getObject('RegisterEventTag');

		$this->assertInstanceOf('RegisterEventTag', $TagCopy);
		$this->assertSame($Tag, $TagCopy);

		$NewTag = ClassRegistry::init(array('class' => 'RegisterEventTag', 'alias' => 'NewTag'));
		$this->assertInstanceOf('RegisterEventTag', $Tag);

		$NewTagCopy = ClassRegistry::init(array('class' => 'RegisterEventTag', 'alias' => 'NewTag'));
 ...
 */
	public function testClassRegistryFlush() {
		ClassRegistry::init('RegisterEventTag');

		$EventTag = ClassRegistry::getObject('RegisterEventTag');
		$this->assertInstanceOf('RegisterEventTag', $EventTag);
		ClassRegistry::flush();

		$NoEventTag = ClassRegistry::isKeySet('RegisterEventTag');
		$this->assertFalse($NoEventTag);
		$this->assertInstanceOf('RegisterEventTag', $EventTag);
	}
 ...
 */
	public function testAddMultipleModels() {
		$Event = ClassRegistry::isKeySet('Event');
		...
		$models = array(array('class' => 'RegisterEvent', 'alias' => 'Event'),
				array('class' => 'RegisterEventFeatured', 'alias' => 'Featured'),
				array('class' => 'RegisterEventTag', 'alias' => 'Tag'));
		...
		$this->assertInstanceOf('RegisterEvent', $Event);

		$Featured = ClassRegistry::getObject('Featured');
		$this->assertInstanceOf('RegisterEventFeatured', $Featured);
 ...
 */
	public function testPrefixedTestDatasource() {
		...
		$Model = ClassRegistry::init('RegisterEvent');
		$this->assertEquals('test', $Model->useDbConfig);
		$Model = ClassRegistry::init('RegisterPrefixedDs');
