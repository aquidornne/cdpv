 ...
 */
	public function testKeyCheck() {
		...
		$data = array(
			array(
				'Event' => array('id' => '1', 'user_id' => '1', 'title' => 'First Event', 'body' => 'First Event Body', 'published' => 'Y', 'created' => '2007-03-18 10:39:23', 'updated' => '2007-03-18 10:41:31'),
				...
				'Comment' => array(
					array('id' => '1', 'article_id' => '1', 'user_id' => '2', 'comment' => 'First Comment for First Event', 'published' => 'Y', 'created' => '2007-03-18 10:45:23', 'updated' => '2007-03-18 10:47:31'),
					array('id' => '2', 'article_id' => '1', 'user_id' => '4', 'comment' => 'Second Comment for First Event', 'published' => 'Y', 'created' => '2007-03-18 10:47:23', 'updated' => '2007-03-18 10:49:31'),
				),
				'Tag' => array(
			...
			array(
				'Event' => array('id' => '3', 'user_id' => '1', 'title' => 'Third Event', 'body' => 'Third Event Body', 'published' => 'Y', 'created' => '2007-03-18 10:43:23', 'updated' => '2007-03-18 10:45:31'),
				'User' => array('id' => '1', 'user' => 'mariano', 'password' => '5f4dcc3b5aa765d61d8327deb882cf99', 'created' => '2007-03-17 01:16:23', 'updated' => '2007-03-17 01:18:31'),
				'Comment' => array(),
				'Tag' => array()
			)
		);
		$this->assertTrue(Set::check($data, '0.Event.user_id'));
		$this->assertTrue(Set::check($data, '0.Comment.0.id'));
		$this->assertFalse(Set::check($data, '0.Comment.0.id.0'));
		$this->assertTrue(Set::check($data, '0.Event.user_id'));
		$this->assertFalse(Set::check($data, '0.Event.user_id.a'));
	}
 ...
 */
	public function testExtract() {
		...
		$expected = array(3);
		$r = Set::extract('/Event[:last]/id', $common);
		$this->assertEquals($expected, $r);
 ...
 */
	public function testExtractWithNonZeroArrays() {
		...
		$expected = array(0 => array('Event' => array('id' => 1, 'approved' => 1)));
		$result = Set::extract('/Event[approved=1]', $startingAtOne);
		$this->assertEquals($expected, $result);
 ...
 */
	public function testMatches() {
		$a = array(
			array('Event' => array('id' => 1, 'title' => 'Event 1')),
			array('Event' => array('id' => 2, 'title' => 'Event 2')),
			array('Event' => array('id' => 3, 'title' => 'Event 3'))
		);

		$this->assertTrue(Set::matches(array('id=2'), $a[1]['Event']));
		$this->assertFalse(Set::matches(array('id>2'), $a[1]['Event']));
		$this->assertTrue(Set::matches(array('id>=2'), $a[1]['Event']));
		$this->assertFalse(Set::matches(array('id>=3'), $a[1]['Event']));
		$this->assertTrue(Set::matches(array('id<=2'), $a[1]['Event']));
		$this->assertFalse(Set::matches(array('id<2'), $a[1]['Event']));
		$this->assertTrue(Set::matches(array('id>1'), $a[1]['Event']));
		$this->assertTrue(Set::matches(array('id>1', 'id<3', 'id!=0'), $a[1]['Event']));

		$this->assertTrue(Set::matches(array('3'), null, 3));
		$this->assertTrue(Set::matches(array('5'), null, 5));

		$this->assertTrue(Set::matches(array('id'), $a[1]['Event']));
		$this->assertTrue(Set::matches(array('id', 'title'), $a[1]['Event']));
		$this->assertFalse(Set::matches(array('non-existant'), $a[1]['Event']));

		$this->assertTrue(Set::matches('/Event[id=2]', $a));
		$this->assertFalse(Set::matches('/Event[id=4]', $a));
		...
		$this->assertEquals(array('comment', 'published'), Set::extract('/Event/keep/Comment/fields', $r));
		$this->assertEquals(array('user'), Set::extract('/Event/keep/User/fields', $r));
	}
 ...
 */
	public function testClassicExtract() {
		...
		$result = Set::extract($a, '{n}.Event.id');
		$expected = array(1, 2, 3);
		$this->assertEquals($expected, $result);

		$result = Set::extract($a, '{n}.Event.title');
		$expected = array('Event 1', 'Event 2', 'Event 3');
		$this->assertEquals($expected, $result);

		$result = Set::extract($a, '1.Event.title');
		$expected = 'Event 2';
		$this->assertEquals($expected, $result);

		$result = Set::extract($a, '3.Event.title');
		$expected = null;
		$this->assertEquals($expected, $result);

		$a = array(
			array(
				'Event' => array('id' => 1, 'title' => 'Event 1',
				'User' => array('id' => 1, 'username' => 'mariano.iglesias'))
			),
			array(
				'Event' => array('id' => 2, 'title' => 'Event 2',
				'User' => array('id' => 1, 'username' => 'mariano.iglesias'))
			),
			array(
				'Event' => array('id' => 3, 'title' => 'Event 3',
				'User' => array('id' => 2, 'username' => 'phpnut'))
			)
		);

		$result = Set::extract($a, '{n}.Event.User.username');
		...
		$result = Set::extract($a, '{n}.Event.Comment.{n}.id');
		$expected = array(array(10, 11, 12), array(13, 14), null);
		$this->assertEquals($expected, $result);

		$result = Set::extract($a, '{n}.Event.Comment.{n}.title');
		$expected = array(
		...
		$result = Set::extract($a, 'articles.{n}.Event.id');
		$expected = array(1, 2, 3);
		$this->assertEquals($expected, $result);

		$result = Set::extract($a, 'articles.{n}.Event.title');
		$expected = array('Event 1', 'Event 2', 'Event 3');
		$this->assertEquals($expected, $result);
		...
		$result = Set::extract($a, 'articles.0.Event.title');
		$expected = 'Event 1';
		$this->assertEquals($expected, $result);
	}
 ...
 */
	public function testMapReverse() {
		...
		$expected = array('User' => array('psword' => 'whatever',
						...
						'Comment' => array(
								array('id' => 1, 'article_id' => 1, 'user_id' => 1, 'comment' => 'First Comment for First Event', 'published' => 'Y', 'created' => '2007-03-18 10:47:23', 'updated' => '2007-03-18 10:49:31'),
								array('id' => 2, 'article_id' => 1, 'user_id' => 2, 'comment' => 'Second Comment for First Event', 'published' => 'Y', 'created' => '2007-03-18 10:47:23', 'updated' => '2007-03-18 10:49:31'))));
		...
		$class->User->Comment->{'0'}->comment = 'First Comment for First Event';
		...
		$class->User->Comment->{'1'}->comment = 'Second Comment for First Event';
		...
		$comment->user_id = 1;
		$comment->comment = 'First Comment for First Event';
		$comment->published = 'Y';
		...
		$comment2->user_id = 2;
		$comment2->comment = 'Second Comment for First Event';
