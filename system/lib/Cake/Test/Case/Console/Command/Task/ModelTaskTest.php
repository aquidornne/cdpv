 ...
 */
	public function testGetTableName() {
		...
		$result = $this->Task->getTable('BakeEvent', 'test');
 ...
 */
	public function testHasManyHasOneGeneration() {
		$model = new Model(array('ds' => 'test', 'name' => 'BakeEvent'));
		$this->Task->connection = 'test';
		$this->Task->listAll();
 ...
 */
	public function testBakeFixture() {
		...
		$this->Task->interactive = true;
		$this->Task->Fixture->expects($this->at(0))->method('bake')->with('BakeEvent', 'bake_articles');
		$this->Task->bakeFixture('BakeEvent', 'bake_articles');
 ...
 */
	public function testBakeTest() {
		$this->Task->plugin = 'TestPlugin';
		$this->Task->interactive = true;
		$this->Task->Test->expects($this->at(0))->method('bake')->with('Model', 'BakeEvent');
		$this->Task->bakeTest('BakeEvent');
 ...
 */
	public function testBakeValidation() {
		...
		$result = $this->Task->bake('BakeEvent', compact('validate'));
		$this->assertRegExp('/class BakeEvent extends AppModel \{/', $result);
 ...
 */
	public function testBakeRelations() {
		...
		$result = $this->Task->bake('BakeEvent', compact('associations'));
 ...
 */
	public function testBakeWithPlugin() {
		...
		$path = APP . 'Plugin' . DS . 'ControllerTest' . DS . 'Model' . DS . 'BakeEvent.php';
		$this->Task->expects($this->once())->method('createFile')
			->with($path, $this->stringContains('BakeEvent extends ControllerTestAppModel'));

		$result = $this->Task->bake('BakeEvent', array(), array());
 ...
 */
	public function testExecuteWithNamedModel() {
		$this->Task->connection = 'test';
		$this->Task->path = '/my/path/';
		$this->Task->args = array('BakeEvent');
		$filename = '/my/path/BakeEvent.php';

		$this->Task->expects($this->once())->method('_checkUnitTest')->will($this->returnValue(1));
		$this->Task->expects($this->once())->method('createFile')
			->with($filename, $this->stringContains('class BakeEvent extends AppModel'));
 ...
 */
	public function testExecuteIntoAll() {
		...
		$this->Task->expects($this->at(1))->method('createFile')
			->with($filename, $this->stringContains('class BakeEvent'));

		$filename = '/my/path/BakeEventsBakeTag.php';
		$this->Task->expects($this->at(2))->method('createFile')
			->with($filename, $this->stringContains('class BakeEventsBakeTag'));
