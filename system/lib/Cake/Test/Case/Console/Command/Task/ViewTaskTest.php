 ...
 */
	public $belongsTo = array(
		'Event' => array(
			'className' => 'TestTest.ViewTaskEvent',
...
/**
 * Test View Task Event Model
 *
 * @package       Cake.Test.Case.Console.Command.Task
 */
class ViewTaskEvent extends Model {
...
/**
 * Test View Task Events Controller
 *
 * @package       Cake.Test.Case.Console.Command.Task
 */
class ViewTaskEventsController extends Controller {
	...
	public function testBakeView() {
		...
		$this->Task->expects($this->at(0))->method('createFile')
			->with(
				...
				$this->stringContains('View Task Events')
			);
	...
	public function testBakeIndex() {
		...
		$this->Task->expects($this->at(0))->method('createFile')
			->with(
				...
				$this->stringContains("\$viewTaskComment['Event']['title']")
			);
 ...
 */
	public function testBakeWithPlugin() {
		...
		$this->assertNotContains('List Test Test.view Task Events', $result);
 ...
 */
	public function testExecuteWithControllerAndAdminFlag() {
		$_back = Configure::read('Routing');
		Configure::write('Routing.prefixes', array('admin'));
		$this->Task->args[0] = 'ViewTaskEvents';
