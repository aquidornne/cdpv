 ...
 * @package       Cake.Test.Case.Console.Command.Task
 */
class TestTaskEvent extends Model {
 ...
 */
	public function testMethodIntrospection() {
		$result = $this->Task->getTestableMethods('TestTaskEvent');
 ...
 */
	public function testFixtureArrayGenerationFromModel() {
		$subject = ClassRegistry::init('TestTaskEvent');
 ...
 */
	public function testBakeModelTest() {
		...
		$result = $this->Task->bake('Model', 'TestTaskEvent');

		$this->assertContains("App::uses('TestTaskEvent', 'Model')", $result);
		$this->assertContains('class TestTaskEventTest extends CakeTestCase', $result);

		$this->assertContains('function setUp()', $result);
		$this->assertContains("\$this->TestTaskEvent = ClassRegistry::init('TestTaskEvent')", $result);

		$this->assertContains('function tearDown()', $result);
		$this->assertContains('unset($this->TestTaskEvent)', $result);
